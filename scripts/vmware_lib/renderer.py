...
def _render_linux_install() -> list[str]:
    ...
    return [
        ...
        "",
        "> 官方安装文档：[VMware · Installing Workstation Pro on Linux]"
        "(https://docs.vmware.com/en/VMware-Workstation-Pro/17.0/com.vmware.ws.using.doc/GUID-832D3ABB-DE30-4BED-9A36-2E0154F0A2ED.html)",
        "",
    ]
